...
namespace VipSoft.FastReflection
{
    public static class FastReflectionExtensions
    {
        ...
        public static object FastGetDbValue(this PropertyInfo propertyInfo, object instance)
        {
            return FastReflectionCaches.PropertyAccessorCache.Get(propertyInfo).GetDbValue(propertyInfo.PropertyType, instance);
        }

        //public static string FastGetDbValue(this PropertyInfo propertyInfo, object instance)
        //{
        //    return FastReflectionCaches.PropertyAccessorCache.Get(propertyInfo).GetDbValue(propertyInfo.PropertyType , instance);
        //}
