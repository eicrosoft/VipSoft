...
namespace VipSoft.FastReflection
{
    public interface IPropertyAccessor
    {
        ...
        object GetDbValue(Type type, object instance);
    ...
    public class PropertyAccessor : IPropertyAccessor
    {
        ...
        private static readonly DateTime MinData = DateTime.MinValue;
        ...
        public object GetDbValue(Type type, object o)
        {
