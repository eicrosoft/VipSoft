...
{
    /// <summary>
    /// A ORM Driver for using the Oracle.DataAccess.Lite DataProvider
    /// </summary>
    public class OracleLiteDataClientDriver : ReflectionBasedDriver
    {
        /// <summary>
        ...
        /// </exception>
        public OracleLiteDataClientDriver(): base("Oracle.DataAccess.Lite")
        {
        }
