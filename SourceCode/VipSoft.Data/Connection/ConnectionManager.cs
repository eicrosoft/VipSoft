...
namespace VipSoft.Data.Connection
{
    ...
    public class ConnectionManager : ISerializable, IDeserializationCallback
    {
        ...
        public void Reconnect()
        {
            if (IsConnected)
            {
                throw new Exception("session already connected");
            }
        ...
        private IDbConnection DisconnectSuppliedConnection()
        {
            if (connection == null)
            {
                throw new Exception("Session already disconnected");
            }
        ...
        public void AfterTransaction()
        {
            ...
            else if (IsOnCloseRelease)
            {
                ...
                // log.Debug("transaction completed on session with on_close connection release mode; be sure to close the session to release ADO.Net resources!");
            }
            transaction = null;
        }
