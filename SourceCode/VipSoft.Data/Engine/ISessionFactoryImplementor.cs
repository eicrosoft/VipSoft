...
{
    /// <summary>
    /// Defines the internal contract between the <c>ISessionFactory</c> and other parts of ORM
    /// such as implementors of <c>IType</c>.
    /// </summary>
    public interface ISessionFactoryImplementor :ISessionFactory // IMapping, ISessionFactory
    {
        /// <summary>
        ...
        ISession OpenSession(IDbConnection connection, bool autoCloseSessionEnabled,ConnectionReleaseMode connectionReleaseMode);
...
/*
		...
		//#endregion
 		/// <summary>
		/// Get the SQL <see cref="Dialect.Dialect"/>.
		/// </summary>
