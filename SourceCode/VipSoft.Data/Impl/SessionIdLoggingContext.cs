...
namespace VipSoft.Data.Impl
{
    public class SessionIdLoggingContext : IDisposable
    {
        ...
        private const string CurrentSessionIdKey = "VipSoft.Data.Impl.SessionIdLoggingContext.CurrentSessionId";
        ...
        public static Guid? SessionId
        {
            get
            {
                if (HttpContext.Current != null) return (Guid?)HttpContext.Current.Items[CurrentSessionIdKey];
